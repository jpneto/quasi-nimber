...
# Ls = [{2,4,6}, {1,2}, {1,4}, {6,7}, {1,4,7}, {1,2,3,4,5}]
# Rs = [{1,2,3}, {1,3}, {2,6}, {1,2}, {3,2,6}, {1,2,3,4,5}]
# print(solve(Ls, Rs))

#####################
# print( solve([{1,2}], [{0,3,6}]) )
# print( solve([{1,2}, {4}], [{1}, {4,3}]) )
# print( solve([{1,2}, {0,3,6}, {4}], [{5,6}, {1}, {4,3}]) )
# print( solve([{1,2}, {0,3,6}, {4}, {1,2}], [{1,2,3}, {5,6}, {1}, {4,3}]) )
# print( solve([{1}, {1,2}, {0,3,6}, {4}, {1,2}], [{1}, {1,2,3}, {5,6}, {1}, {4,3}]) )
# print( solve([{1}, {1}, {1,2}, {0,3,6}, {4}, {1,2}], [{1}, {1}, {1,2,3}, {5,6}, {1}, {4,3}]) )
# print(count)
#####################
